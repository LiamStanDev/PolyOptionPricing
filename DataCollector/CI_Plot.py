...
def Call():
    ...
    simulation_res = {"GBM": [(6.88532431, 6.89239491), 0.001767647865768763],
    ...
    plot_N_Config = {"GBM": np.array(list(range(10, 300, 2))),
    ...
    for process_name in processes.keys():
        ...
        densityRecover = DensityRecover(S0=S0, process_cf=processes[process_name], poly_coeff=poly_coeff, positive_interval=positive_interval, error_acceptance=1e-6)
        ...
        # 畫圖
        plotValueWithCV(N_list, val_list, simulation_res[process_name][0], simulation_res[process_name][1], "./Data/Error", "value-plot-" + process_name + "-call")
...
def RightUp():
    ...
    simulation_res = {"GBM": [(9.34389677, 9.38341305), 0.009879068455075636],
    ...
    for process_name in processes.keys():
        ...
        densityRecover = DensityRecover(S0=S0, process_cf=processes[process_name], poly_coeff=poly_coeff,
                                        positive_interval=positive_interval, error_acceptance=1e-6, assume_true_b=1e15)
        ...
        # 畫圖
        plotValueWithCV(N_list, val_list, simulation_res[process_name][0], simulation_res[process_name][1],
                        "./Data/Error", "value-plot-" + process_name + "-rightup")
...
def LeftUp():
    ...
    simulation_res = {"GBM": [(31.98613631, 31.99895833), 0.0032055048228150666],
    ...
    plot_N_Config = {"GBM": np.array(list(range(80, 300, 1))),
    ...
    for process_name in processes.keys():
        ...
        # 畫圖
        plotValueWithCV(N_list, val_list, simulation_res[process_name][0], simulation_res[process_name][1],
                        "./Data/Error", "value-plot-" + process_name + "-leftup")
...
def BothUp():
    ...
    simulation_res = {"GBM": [(43.01140318, 43.02118617), 0.0024457484026965],
    ...
    plot_N_Config = {"GBM": np.array(list(range(100, 200, 1))),
    ...
    for process_name in processes.keys():
        ...
        # 畫圖
        plotValueWithCV(N_list, val_list, simulation_res[process_name][0], simulation_res[process_name][1],
                        "./Data/Error", "value-plot-" + process_name + "-bothup")
...
def BothDown():
    ...
    simulation_res = {"GBM": [(48.73786033, 48.77377146), 0.008977782334233924],
    ...
    for process_name in processes.keys():
        ...
        # 畫圖
        plotValueWithCV(N_list, val_list, simulation_res[process_name][0], simulation_res[process_name][1],
                        "./Data/Error", "value-plot-" + process_name + "-bothdown")
